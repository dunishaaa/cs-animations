...
El for y el while son esencialmente igual. Podemos simplificarlo a simpmenente decir "haz esto una y otra vez mientras
esto sea cierto

Ambos ciclos funcionan esencialmente asi. Haz esto una y otra vez mientras esta condicion se cumpla y cuando ya no se
cumpla, deja de repetirlo.

Un caso especifico puede ser el anterior

Para i < 100 haz estos pasos... Especificamente podemos decir,
inicializa i = 0, para i < 100 haz estos pasos y luego sumale 1 a i al final de los pasos. Podemos ver que todos los
pasos se van a repetir 100 veces

Retomando el ejemplo anterior lo podriamos formular como Para x < 100 suma 1 a x, entonces cuando llegamos a 100 se
rompe la condicion y tenemos que parar
Pero mientras no se cumpla la condicion tenemos que repetir una y otra vez los pasos definidos, por eso le llamamos
ciclo
